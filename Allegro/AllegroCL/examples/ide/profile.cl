...
(defun run-profile-example ()
  ...
  (when (standalone-application (app *system*))
    (pop-up-message-dialog 
     ...
     #.(format nil "This example uses the Profile Dialog and other facilities ~
  ...
  ;; Show the profile dialog and "click" its Update button
  ;; to show the results of the profile.

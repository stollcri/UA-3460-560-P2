...
public class LispAsyncHttpServlet extends LispHttpServlet {
       ...
       throws javax.servlet.ServletException 
  {
    ...
    res = JavaLinkDist.invokeInLisp
             ( 2, JavaLinkDist.newDistOb("javatools.jlinker:start-work"), 
	       args );
  ...
  public void doDelete(HttpServletRequest request,
       ...
       throws javax.servlet.ServletException 
  {
    startRequest(request, response, "javatools.jlinker:do-delete");
  }
  ...
  public void doGet(HttpServletRequest request,
       ...
       throws javax.servlet.ServletException 
  {
    startRequest(request, response, "javatools.jlinker:do-get");
  }
  ...
  public void doHead(HttpServletRequest request,
       ...
       throws javax.servlet.ServletException
  {
    startRequest(request, response, "javatools.jlinker:do-head");
  }
  ...
  {
    startRequest(request, response, "javatools.jlinker:do-options");
  }
  ...
  public void doPost(HttpServletRequest request,
       ...
       throws javax.servlet.ServletException
  {
    startRequest(request, response, "javatools.jlinker:do-post");
  }
  ...
  public void doPut(HttpServletRequest request,
       ...
       throws javax.servlet.ServletException
  {
    startRequest(request, response, "javatools.jlinker:do-put");
  }
  ...
  public void doTrace(HttpServletRequest request,
       ...
       throws javax.servlet.ServletException
  {
    startRequest(request, response, "javatools.jlinker:do-trace");
  }

...
public class LispHttpServlet extends HttpServlet {
  ...
  public String lispClassName = "javatools.jlinker:http-servlet";
  ...
  public void init()  throws ServletException 
  {
    ...
    res = JavaLinkDist.invokeInLisp
            ( 2, 
	      JavaLinkDist.newDistOb("javatools.jlinker:new-servlet"), 
	      args );
  ...
  public void doDelete(HttpServletRequest request,
       ...
       throws javax.servlet.ServletException 
  {
    doRequest(request, response, "javatools.jlinker:do-delete");
  }
  ...
  public void doGet(HttpServletRequest request,
       ...
       throws javax.servlet.ServletException 
  {
    doRequest(request, response, "javatools.jlinker:do-get");
  }
  ...
  public void doHead(HttpServletRequest request,
       ...
       throws javax.servlet.ServletException
  {
    doRequest(request, response, "javatools.jlinker:do-head");
  }
  ...
  {
    doRequest(request, response, "javatools.jlinker:do-options");
  }
  ...
  public void doPost(HttpServletRequest request,
       ...
       throws javax.servlet.ServletException
  {
    doRequest(request, response, "javatools.jlinker:do-post");
  }
  ...
  public void doPut(HttpServletRequest request,
       ...
       throws javax.servlet.ServletException
  {
    doRequest(request, response, "javatools.jlinker:do-put");
  }
  ...
  public void doTrace(HttpServletRequest request,
       ...
       throws javax.servlet.ServletException
  {
    doRequest(request, response, "javatools.jlinker:do-trace");
  }
  ...
  public void destroy() 
  {
	...
	res = JavaLinkDist.invokeInLisp
	         ( 2, JavaLinkDist.newDistOb("javatools.jlinker:destroy-servlet"), 
		   args );
	lispServlet = null;
      }
  }

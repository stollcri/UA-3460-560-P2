...
(define-project :name :window-methods-example
  :modules (list (make-instance 'module :name "winmeth"))
  :projects nil
  :libraries nil
  ...
  :runtime-modules '(:cg-dde-utils :cg.base :cg.bitmap-pane
                     ...
                     :cg.curve :cg.dialog-item :cg.editable-text
                     :cg.icon :cg.keyboard-shortcuts :cg.lisp-widget
                     :cg.message-dialog :cg.multi-line-editable-text
                     :cg.multi-picture-button :cg.os-widget
  ...
  :on-initialization 'run-window-methods-example

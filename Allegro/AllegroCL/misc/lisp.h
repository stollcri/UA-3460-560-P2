...
#define TagOffset (-16)
#else
#if defined(m88k) || defined(IBM32Bit) || defined(HP32Bit) || defined(MacOSX32)
#define TagOffset 8
#else
#define TagOffset 0
#endif
...
EXTERN DLLIMPORT LispVal *symbol_locative(LispVal);
...
EXTERN DLLIMPORT LispVal nilval;
EXTERN DLLIMPORT LispVal tval;
...
typedef void (*LispInit)(int,char **,char **,
